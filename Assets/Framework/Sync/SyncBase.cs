...
namespace Framework.Sync
{
    ...
    {
        public delegate void DlgtPropertyChanged(SyncBase InObj, string InPropertyName, object InOldValue, object InCurrentValue);
        ...
        public void OnPropertyChanged(string InPropertyName, object InOldValue, object InPropertyValue)
        {
            ...
            if (propertyChangedDict.TryGetValue(InPropertyName, out del))
                del(this, InPropertyName, InOldValue, InPropertyValue);
        }
    }
}
